...
`wget` を使う場合:
```console
$ wget https://github.com/akinomyoga/ble.sh/releases/download/v0.3.0-beta1/ble-0.3.0-beta1.tar.xz
$ tar xJf ble-0.3.0-beta1.tar.xz
$ source ble-0.3.0-beta1/ble.sh
```
`curl` を使う場合:
```console
$ curl -LO https://github.com/akinomyoga/ble.sh/releases/download/v0.3.0-beta1/ble-0.3.0-beta1.tar.xz
$ tar xJf ble-0.3.0-beta1.tar.xz
$ source ble-0.3.0-beta1/ble.sh
```
...
```console
$ cp -r ble-0.3.0-beta1 /path/to/blesh
```
