...
- canvas: use `_ble_term_invis` to hide characters used to determine char-width modes (requested by tessus) `#D2223` xxxxxxxx
  - canvas: hide cursor during char-width detection (requested by tessus) `#D2232` xxxxxxxx
